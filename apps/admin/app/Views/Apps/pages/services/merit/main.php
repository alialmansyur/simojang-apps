            ...
            <div class="col-12">
                <div class="alert shadow-sm border-0 rounded-3 p-3 position-relative mb-0" style="background-color: #fffbe4; border-left: 6px solid #f59e0b !important;" role="alert">
                    <div class="row align-items-center g-0 pe-5">
                        ...
                        <div class="col">
                            <h6 class="fw-bold mb-1" style="color: #92400e; font-size: 0.95rem; line-height: 1.3;">Himbauan: Pengawasan &amp; Pengendalian Penerapan Sistem Merit</h6>
                            <div style="font-size: 0.85rem; color: #b45309; line-height: 1.35;">Pastikan seluruh data realisasi usulan dan kepatuhan Service Level Agreement (SLA) layanan kepegawaian tercatat secara akurat.</div>
                        </div>
                    </div>
                    ...
                    <div class="collapse" id="tataCaraCollapse">
                        ...
                        <ol class="mb-0 ps-3" style="font-size: 0.85rem; line-height: 1.7; color: #78350f;">
                            <li><strong>Filter Periode &amp; Tinjau Capaian:</strong> Gunakan dropdown <em>Pilih Bulan</em> untuk menyaring data usulan serta meninjau persentase kepatuhan SLA pada kartu rekap.</li>
                            <li><strong>Entri Data Realisasi Usulan:</strong> Klik tombol <strong>"Tambah Data"</strong>, tentukan <em>Period</em> serta rentang tanggal penarikan data.</li>
                            <li><strong>Lengkapi Data MS, TMS &amp; SLA:</strong> Masukkan jumlah <em>Usul Masuk</em>, rincian status (MS &amp; TMS), serta jumlah usulan yang memenuhi SLA (&lt; 4 HK) dan melebihi SLA.</li>
                            <li><strong>Simpan &amp; Rekapitulasi:</strong> Klik <strong>"Simpan Data"</strong> untuk memperbarui rekapitulasi pengawasan sistem merit di Kanreg III BKN.</li>
                        </ol>
                    </div>
                </div>
            </div>
