            ...
            <div class="col-12">
                <div class="alert shadow-sm border-0 rounded-3 p-3 position-relative mb-0" style="background-color: #fffbe4; border-left: 6px solid #f59e0b !important;" role="alert">
                    <div class="row align-items-center g-0 pe-5">
                        ...
                        <div class="col">
                            <h6 class="fw-bold mb-1" style="color: #92400e; font-size: 0.95rem; line-height: 1.3;">Himbauan: Pengukuran &amp; Evaluasi Indeks NSPK Manajemen ASN</h6>
                            <div style="font-size: 0.85rem; color: #b45309; line-height: 1.35;">Pastikan hasil penilaian indeks NSPK dan data dukung implementasi norma, standar, prosedur, serta kriteria kepegawaian instansi tercatat valid.</div>
                        </div>
                    </div>
                    ...
                    <div class="collapse" id="tataCaraCollapse">
                        ...
                        <ol class="mb-0 ps-3" style="font-size: 0.85rem; line-height: 1.7; color: #78350f;">
                            <li><strong>Filter Periode Evaluasi:</strong> Gunakan dropdown <em>Pilih Bulan</em> untuk menyaring riwayat penilaian serta memantau rata-rata indeks instansi.</li>
                            <li><strong>Entri Data Penilaian:</strong> Klik tombol <strong>"Tambah Data"</strong>, tentukan <em>Period</em>, serta rentang tanggal penarikan data (Tanggal Mulai s.d. Selesai).</li>
                            <li><strong>Pilih Instansi &amp; Level:</strong> Pilih <em>Instansi</em> yang dinilai serta tentukan <em>Level / Peringkat / Nilai</em> (A / B / C) sesuai hasil verifikasi.</li>
                            <li><strong>Simpan Data:</strong> Klik <strong>"Simpan Data"</strong> untuk memperbarui rekapitulasi indeks NSPK instansi di wilayah kerja Kanreg III BKN.</li>
                        </ol>
                    </div>
                </div>
            </div>
