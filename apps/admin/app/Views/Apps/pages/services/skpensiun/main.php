...
$serviceTitle = 'Penetapan SK Pensiun Janda/Duda Pensiunan PNS';
$layananId = 11;
$docType = 'Penetapan SK Pensiun Janda/Duda Pensiunan PNS';
$docCategoryDefault = '';
...
<link rel="stylesheet" href="<?= asset_url('apps/assets/css/pages/services/skpensiun/main.css') ?>">
<?= $this->endSection(); ?>
