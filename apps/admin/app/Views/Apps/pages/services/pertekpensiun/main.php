...
$serviceTitle = 'Penetapan Pertek Pensiun PNS dan Janda / Dudanya';
$layananId = 10;
$docType = 'Penetapan Pertek Pensiun PNS dan Janda / Dudanya';
$docCategoryDefault = '';
...
<link rel="stylesheet" href="<?= asset_url('apps/assets/css/pages/services/pertekpensiun/main.css') ?>">
<?= $this->endSection(); ?>
