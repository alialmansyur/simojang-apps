...
$serviceTitle = 'Penetapan NIP CPNS / NI PPPK';
$layananId = 2;
$docType = 'Penetapan NIP';
...
$categoryOptions = (isset($categoryOptions) && is_array($categoryOptions) && !empty($categoryOptions))
    ? $categoryOptions
    : $defaultEventOptions;
$docCategoryDefault = (isset($docCategoryDefault) && is_string($docCategoryDefault) && $docCategoryDefault !== '')
    ? $docCategoryDefault
    : (array_key_first($categoryOptions) ?: '');
$eventCrudEnabled = isset($eventCrudEnabled) ? (bool) $eventCrudEnabled : false;
$sampleFile = 'apps/samples/sample-tapnip.xlsx';
...
<div class="page-content py-4">
    <div class="container-fluid text-start mx-auto tw-wrap" style="max-width: 1160px; padding: 0 .85rem 1.05rem;">
            ...
            <div class="col-md-12">
                <div class="service-ui-topbar service-ui-static-topbar module-topbar">
                            ...
                            <div class="service-ui-topbar-actions module-action-row">
                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#tapnipEventModal">
                                    <i class="bi bi-plus-circle me-1"></i> <strong>Tambah Event</strong>
                                </button>
        ...
        <div class="modal fade" id="tapnipEventModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5">Kelola Event TapNIP</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="alert alert-warning py-2 px-3 mb-3 <?= $eventCrudEnabled ? 'd-none' : '' ?>" id="tapnipEventPatchWarning">
                            Tabel event belum siap. Jalankan SQL patch terlebih dahulu.
                        </div>

                        <form id="tapnipEventForm" autocomplete="off">
                            <input type="hidden" id="tapnip_event_id" name="id">
                            <div class="row g-2">
                                <div class="col-md-8">
                                    <label class="form-label mb-1">Nama Event</label>
                                    <input type="text" class="form-control" id="tapnip_event_name" name="nama" placeholder="Contoh: 2026 - Penetapan NI PPPK Tahap I" required>
                                </div>
                                <div class="col-md-4 d-flex align-items-end">
                                    <button type="submit" class="btn btn-primary w-100" id="tapnipEventSubmitBtn">
                                        Simpan Event
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="event-table-wrap">
                            <table class="table table-sm table-bordered align-middle mb-0">
                                <thead>
                                    <tr>
                                        <th>Nama Event</th>
                                        <th class="text-center tapnip-event-action-col">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody id="tapnipEventTableBody">
                                    <tr>
                                        <td colspan="2" class="text-center text-muted py-3">Memuat data event...</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" id="tapnipEventResetBtn">Reset</button>
