...
$serviceTitle = 'Peninjauan Masa Kerja';
$layananId = 5;
$docType = 'Peninjauan Masa Kerja';
$docCategoryDefault = '';
$showCategoryFilter = false;
$sampleFile = 'uploads/sample/sample_general_1.xlsx';
...
<link rel="stylesheet" href="<?= asset_url('apps/assets/css/pages/services/peninjauanmasakerja/main.css') ?>">
<?= $this->endSection(); ?>
