            ...
            <div class="col-12">
                <div class="alert shadow-sm border-0 rounded-3 p-3 position-relative mb-0" style="background-color: #fffbe4; border-left: 6px solid #f59e0b !important;" role="alert">
                    <div class="row align-items-center g-0 pe-5">
                        ...
                        <div class="col">
                            <h6 class="fw-bold mb-1" style="color: #92400e; font-size: 1rem; line-height: 1.2;">Himbauan: Pemantauan &amp; Implementasi Manajemen Talenta ASN</h6>
                            <div style="font-size: 0.85rem; color: #b45309; line-height: 1.2;">Pastikan progres tahapan implementasi Manajemen Talenta di setiap instansi diverifikasi dan diperbarui secara berkala sesuai regulasi yang berlaku.</div>
                        </div>
                    </div>
                    ...
                    <div class="collapse" id="tataCaraCollapse">
                        ...
                        <ol class="mb-0 ps-3" style="font-size: 0.85rem; line-height: 1.7; color: #78350f;">
                            <li><strong>Filter &amp; Pantau Capaian:</strong> Gunakan tombol filter <em>Pilih Bulan</em> untuk memfilter progres implementasi instansi serta pantau ringkasan pada kartu KPI.</li>
                            <li><strong>Entri Data Progres Instansi:</strong> Klik tombol <strong>"Tambah Data"</strong>, pilih <em>Instansi</em>, tentukan <em>Period</em> dan <em>Tanggal Mulai</em>.</li>
                            <li><strong>Pilih Tahapan Progress:</strong> Tentukan <em>Status Progress</em> sesuai tahapan aktual penerapan manajemen talenta di instansi terkait.</li>
                            <li><strong>Simpan &amp; Perbarui:</strong> Klik <strong>"Simpan Data"</strong> untuk menyimpan rekapitulasi progres dan memperbarui persentase capaian secara otomatis.</li>
                        </ol>
                    </div>
                </div>
            </div>
