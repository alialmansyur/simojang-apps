...
$serviceTitle = 'Pengangkatan CPNS menjadi PNS yang melebihi ketentuan';
$layananId = 9;
$docType = 'Pengangkatan CPNS menjadi PNS yang melebihi ketentuan';
$docCategoryDefault = '';
...
<link rel="stylesheet" href="<?= asset_url('apps/assets/css/pages/services/pengangkatancpns/main.css') ?>">
<?= $this->endSection(); ?>
