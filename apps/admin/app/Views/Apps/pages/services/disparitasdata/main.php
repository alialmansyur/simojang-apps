            ...
            <div class="col-12">
                <div class="alert shadow-sm border-0 rounded-3 p-3 position-relative mb-0" style="background-color: #fffbe4; border-left: 6px solid #f59e0b !important;" role="alert">
                    <div class="row align-items-center g-0 pe-5">
                        ...
                        <div class="col">
                            <h6 class="fw-bold mb-1" style="color: #92400e; font-size: 0.95rem; line-height: 1.3;">Himbauan: Monitoring &amp; Rekonsiliasi Disparitas Data ASN</h6>
                            <div style="font-size: 0.85rem; color: #b45309; line-height: 1.35;">Pastikan data anomali atau perbedaan (disparitas) data kepegawaian antar instansi diverifikasi dan disinkronkan secara berkala.</div>
                        </div>
                    </div>
                    ...
                    <div class="collapse" id="tataCaraCollapse">
                        ...
                        <ol class="mb-0 ps-3" style="font-size: 0.85rem; line-height: 1.7; color: #78350f;">
                            <li><strong>Filter Periode:</strong> Gunakan dropdown <em>Pilih Bulan</em> untuk menyaring riwayat upload dan memantau total disparitas serta progres perbaikan.</li>
                            <li><strong>Upload Data Disparitas:</strong> Klik tombol <strong>"Upload Data Baru"</strong> untuk mengunggah dokumen hasil tarikan disparitas data.</li>
                            <li><strong>Pantau Status &amp; Progres:</strong> Periksa daftar tabel untuk melihat rincian instansi, jumlah data anomali, dan status tindak lanjut rekonsiliasi.</li>
                            <li><strong>Validasi Penyelesaian:</strong> Pastikan seluruh anomali data telah diselesaikan dan tervalidasi pada database kepegawaian nasional.</li>
                        </ol>
                    </div>
                </div>
            </div>
