            ...
            <div class="col-12">
                <div class="alert shadow-sm border-0 rounded-3 p-3 position-relative mb-0" style="background-color: #fffbe4; border-left: 6px solid #f59e0b !important;" role="alert">
                    <div class="row align-items-center g-0 pe-5">
                        ...
                        <div class="col">
                            <h6 class="fw-bold mb-1" style="color: #92400e; font-size: 1rem; line-height: 1.2;">Himbauan: Pengelolaan &amp; Pencatatan Tata Naskah Dinas</h6>
                            <div style="font-size: 0.85rem; color: #b45309; line-height: 1.2;">Pastikan setiap pencatatan surat masuk dan keluar telah diklasifikasikan sesuai kode tata naskah dinas dan periode register yang tepat.</div>
                        </div>
                    </div>
                    ...
                    <div class="collapse" id="tataCaraCollapse">
                        ...
                        <ol class="mb-0 ps-3" style="font-size: 0.85rem; line-height: 1.7; color: #78350f;">
                            <li><strong>Periksa Periode &amp; Rekap:</strong> Gunakan filter <em>Pilih Bulan</em> atau pencarian untuk memeriksa apakah data rekapitulasi persuratan pada periode bersangkutan sudah pernah diinputkan.</li>
                            <li><strong>Entri Data Persuratan:</strong> Klik tombol <strong>"Tambah Data"</strong>, tentukan <em>Period</em>, <em>Rentang Tanggal</em>, dan pilih <em>Jenis Persuratan</em> (Surat Masuk / Surat Keluar).</li>
                            <li><strong>Pilih Kode Klasifikasi:</strong> Tentukan <em>Klasifikasi Arsip</em> yang sesuai dan masukkan total <em>Jumlah Surat</em> yang telah diproses.</li>
                            <li><strong>Simpan &amp; Tertibkan Arsip:</strong> Klik <strong>"Simpan Data"</strong> untuk memperbarui rekapitulasi volume tata naskah dinas di Kanreg III BKN.</li>
                        </ol>
                    </div>
                </div>
            </div>
