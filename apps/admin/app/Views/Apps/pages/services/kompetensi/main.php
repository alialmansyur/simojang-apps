        ...
        <div class="page-heading mb-0">
            <div class="row align-items-center d-flex justify-content-between">
                <div class="col-md-6 text-start">
                    <h3 class=""><b><span class="badge bg-primary rounded mb-2" id="kompetensiBadge">Kompetensi</span><br><span>Data Pemetaan Kompetensi</span></b></h3>
            ...
            <div class="col-md-12">
                <div class="service-ui-topbar mb-3 service-ui-static-topbar">
                    ...
                    <div class="d-flex align-items-center justify-content-end gap-2 flex-nowrap">
                        <a href="<?= base_url('template/sample/template_import_kompetensi.xlsx') ?>" target="_blank" class="btn btn-outline-success">
                ...
                <div id="kpidSummary" class="service-ui-recap mb-3">
                    <div class="service-ui-recap-card">
                        ...
                        <div>
                            ...
                            <h6 class="service-ui-recap-value" id="kpid-total-rekap">0</h6>
                        </div>
                    </div>
                    <div class="service-ui-recap-card">
                        <span class="service-ui-recap-icon">
                        ...
                        <div>
                            ...
                            <h6 class="service-ui-recap-value" id="kpid-total-instansi">0</h6>
                        </div>
                    </div>
                    <div class="service-ui-recap-card">
                        <span class="service-ui-recap-icon">
                        ...
                        <div>
                            <p class="service-ui-recap-label">Total (CACT)</p>
                            <h6 class="service-ui-recap-value" id="kpid-total-peserta-cact">0</h6>
                        </div>
                    </div>
                    <div class="service-ui-recap-card">
                        <span class="service-ui-recap-icon">
                        ...
                        <div>
                            <p class="service-ui-recap-label">Total (Pro ASN)</p>
                            <h6 class="service-ui-recap-value" id="kpid-total-peserta-proasn">0</h6>
                        </div>
                    </div>
                    <div class="service-ui-recap-card">
                        <span class="service-ui-recap-icon">
                        ...
                        <div>
                            <p class="service-ui-recap-label">Total (Integrasi)</p>
                            <h6 class="service-ui-recap-value" id="kpid-total-peserta-integrasi">0</h6>
                        </div>
                    </div>
                    <div class="service-ui-recap-card">
                        <span class="service-ui-recap-icon">
                        ...
                        <div>
                            ...
                            <h6 class="service-ui-recap-value" id="kpid-last-update">-</h6>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="DataModalLabelCreate">Data Kompetensi Baru</h5>
...
<script src="<?= asset_url('apps/assets/js/custom/pages/services/kompetensi/entry.js') ?>"></script>
<script src="<?= asset_url('apps/assets/js/custom/pages/services/kompetensi/tables.js') ?>"></script>
<?= $this->endSection(); ?>
