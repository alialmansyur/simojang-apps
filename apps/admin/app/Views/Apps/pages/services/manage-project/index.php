            ...
            <div class="col-12">
                <div class="alert shadow-sm border-0 rounded-3 p-3 position-relative mb-0" style="background-color: #fffbe4; border-left: 6px solid #f59e0b !important;" role="alert">
                    <div class="row align-items-center g-0 pe-5">
                        ...
                        <div class="col">
                            <h6 class="fw-bold mb-1" style="color: #92400e; font-size: 1rem; line-height: 1.2;">Himbauan: Pengelolaan &amp; Pemantauan Proyek Tim Kerja</h6>
                            <div style="font-size: 0.85rem; color: #b45309; line-height: 1.2;">Kelola progres kegiatan, serapan anggaran, dan tahapan milestone secara berkala agar target kinerja proyek tercapai tepat waktu.</div>
                        </div>
                    </div>
                    ...
                    <div class="collapse" id="tataCaraCollapse">
                        ...
                        <ol class="mb-0 ps-3" style="font-size: 0.85rem; line-height: 1.7; color: #78350f;">
                            <li><strong>Cari &amp; Pilih Proyek:</strong> Gunakan kotak pencarian untuk menemukan proyek yang sudah ada, lalu klik kartu proyek untuk membuka rincian milestone dan tim kerja.</li>
                            <li><strong>Tambah Proyek Baru:</strong> Jika ingin mendaftarkan proyek inovasi/perubahan baru, klik tombol <strong>"Tambah Proyek"</strong> dan lengkapi rincian plafon anggaran serta target waktu.</li>
                            <li><strong>Pantau Progres &amp; Anggaran:</strong> Cek indikator capaian fisik dan serapan anggaran yang ditampilkan secara otomatis pada setiap kartu proyek.</li>
                        </ol>
                    </div>
                </div>
            </div>
