            ...
            <div class="col-12">
                <div class="alert shadow-sm border-0 rounded-3 p-3 position-relative mb-0" style="background-color: #fffbe4; border-left: 6px solid #f59e0b !important;" role="alert">
                    <div class="row align-items-center g-0 pe-5">
                        ...
                        <div class="col">
                            <h6 class="fw-bold mb-1" style="color: #92400e; font-size: 0.95rem; line-height: 1.3;">Himbauan: Digitalisasi &amp; Validasi Berkas Dokumen Kepegawaian (DMS)</h6>
                            <div style="font-size: 0.85rem; color: #b45309; line-height: 1.35;">Pastikan proses alih media dan digitalisasi berkas fisik arsip kepegawaian tercatat dengan jumlah lembar dan status upload yang terverifikasi.</div>
                        </div>
                    </div>
                    ...
                    <div class="collapse" id="tataCaraCollapse">
                        ...
                        <ol class="mb-0 ps-3" style="font-size: 0.85rem; line-height: 1.7; color: #78350f;">
                            <li><strong>Filter Periode:</strong> Gunakan dropdown <em>Pilih Bulan</em> untuk menyaring riwayat upload DMS serta memantau total berkas pada kartu rekap.</li>
                            <li><strong>Tambah Periode Data:</strong> Klik tombol <strong>"Tambah Periode Data"</strong> untuk membuat entri rekapitulasi digitalisasi arsip baru.</li>
                            <li><strong>Rincian Lembar &amp; Instansi:</strong> Masukkan periode bulan, rentang tanggal, pilih instansi, dan tentukan jumlah berkas/lembar yang telah dialihmediakan.</li>
                            <li><strong>Simpan &amp; Rekapitulasi:</strong> Klik <strong>"Simpan Data"</strong> untuk memperbarui progres digitalisasi arsip kepegawaian di Kanreg III BKN.</li>
                        </ol>
                    </div>
                </div>
            </div>
