            ...
            <div class="col-12">
                <div class="alert shadow-sm border-0 rounded-3 p-3 position-relative mb-0" style="background-color: #fffbe4; border-left: 6px solid #f59e0b !important;" role="alert">
                    <div class="row align-items-center g-0 pe-5">
                        ...
                        <div class="col">
                            <h6 class="fw-bold mb-1" style="color: #92400e; font-size: 0.95rem; line-height: 1.3;">Himbauan: Penyajian &amp; Pemutakhiran Statistik Kepegawaian</h6>
                            <div style="font-size: 0.85rem; color: #b45309; line-height: 1.35;">Pastikan data statistik agregat ASN (jumlah, golongan, pendidikan, jabatan, dan demografi) diunggah sesuai format sampel baku.</div>
                        </div>
                    </div>
                    ...
                    <div class="collapse" id="tataCaraCollapse">
                        ...
                        <ol class="mb-0 ps-3" style="font-size: 0.85rem; line-height: 1.7; color: #78350f;">
                            <li><strong>Pilih Kategori Statistik:</strong> Gunakan dropdown <em>Pilih kategori data</em> (Jumlah ASN, Golongan, Pendidikan, Usia, dll.) lalu klik <strong>"Terapkan"</strong>.</li>
                            <li><strong>Unduh Format Sampel:</strong> Klik tombol <strong>"Format Sampel"</strong> untuk mengunduh template spreadsheet resmi sesuai kategori yang dipilih.</li>
                            <li><strong>Upload Data Baru:</strong> Klik tombol <strong>"Upload Data Baru"</strong> lalu unggah file spreadsheet yang telah diisi data agregat kepegawaian.</li>
                            <li><strong>Validasi &amp; Rekapitulasi:</strong> Data yang diunggah akan otomatis diproses dan memperbarui ringkasan statistik kepegawaian Kanreg III BKN.</li>
                        </ol>
                    </div>
                </div>
            </div>
